...
firstFlagLinkFr.addEventListener("click", function (event) {
  ...
  myPortfolioFr.innerHTML =
    "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bienvenue <br> à mon portfolio";
  ...
  footerInfoFr.innerHTML =
    "Geram Hovhannisyan © 2023 <br> Tous droits réservés";
});
